  ...
  for (int i = 0; i < NUM_PINS; i++) {
    ...
    if ((registeredNum[i] != 0) && (previousPinStates[i] != pinStates[i])) {
      eventDispatcher->dispatch(new Event(
          EVENT_SOURCE_SOLENOID, word(0, registeredNum[i]), pinStates[i]));
    }
  }
}
...
void Solenoids::registerJ3(byte pin, byte number) {
  if (pin == 1) {
    registeredNum[0] = number;
  } else if (pin == 2) {
    registeredNum[1] = number;
  } else if (pin == 3) {
    registeredNum[2] = number;
  } else if (pin == 4) {
    registeredNum[3] = number;
  } else if (pin == 5) {
    registeredNum[4] = number;
  }
  // 6 is key
  else if (pin == 7) {
    registeredNum[5] = number;
  }
}
...
void Solenoids::registerJ122(byte pin, byte number) {
  if (pin == 1) {
    registeredNum[6] = number;
  } else if (pin == 2) {
    registeredNum[7] = number;
  } else if (pin == 3) {
    registeredNum[8] = number;
  } else if (pin == 4) {
    registeredNum[9] = number;
  } else if (pin == 5) {
    registeredNum[10] = number;
  } else if (pin == 6) {
    registeredNum[11] = number;
  }
  // 7 is key
  else if (pin == 8) {
    registeredNum[12] = number;
  } else if (pin == 9) {
    registeredNum[13] = number;
  }
}
...
void Solenoids::registerJ125(byte pin, byte number) {
  if (pin == 1) {
    registeredNum[14] = number;
  } else if (pin == 2) {
    registeredNum[15] = number;
  } else if (pin == 3) {
    registeredNum[16] = number;
  }
  // 4 is key
  else if (pin == 5) {
    registeredNum[17] = number;
  } else if (pin == 6) {
    registeredNum[18] = number;
  } else if (pin == 7) {
    registeredNum[19] = number;
  } else if (pin == 8) {
    registeredNum[20] = number;
  } else if (pin == 9) {
    registeredNum[21] = number;
  }
}
...
void Solenoids::registerJ126(byte pin, byte number) {
  ...
  // 9 is key
    ...
    registeredNum[22] = number;
  } else if (pin == 11) {
    registeredNum[23] = number;
  } else if (pin == 12) {
    registeredNum[24] = number;
  } else if (pin == 13) {
    registeredNum[25] = number;
  }
}
