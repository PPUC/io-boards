...
class SinePWMEffect : public WavePWMEffect {
 public:
  SinePWMEffect(unsigned int frequency, unsigned int duration,
                uint8_t maxIntensity = 255, uint8_t minIntensity = 0)
      : WavePWMEffect(frequency, maxIntensity, minIntensity) {
