...
Solenoids* InputController::solenoids() { return _solenoids; }

SwitchMatrix* InputController::switchMatrix() { return _switchMatrix; }

LightMatrix* InputController::lightMatrix() { return _lightMatrix; }

PIN2DMD* InputController::pin2Dmd() { return _pin2Dmd; }

PUPComLink* InputController::pupComLink() { return _pupComLink; }

InputControllerTestButtons* InputController::testButtons() {
  return _testButtons;
}

EventDispatcher* InputController::eventDispatcher() { return _eventDispatcher; }
