...
InputController inputController(PPUC_CONTROLLER, PLATFORM_DATA_EAST,
                                effectsController.eventDispatcher());
...
void setup() {
  ...
  effectsController.addEffect(new WS2812FXEffect(FX_MODE_STATIC, WHITE, 0, 0),
