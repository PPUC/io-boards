...
void setup() {
  ...
  inputController.switchMatrix()->registerFieldAsEvent(3, 1,
                                                       13);  // Start Button
  inputController.switchMatrix()->registerFieldAsEvent(7, 2,
                                                       27);  // Ball Shooter
  inputController.switchMatrix()->registerFieldAsEvent(8, 2,
                                                       28);  // Rocket Kicker
  ...
  inputController.switchMatrix()->registerFieldAsEvent(1, 6,
                                                       61);  // Lower Skill
  inputController.switchMatrix()->registerFieldAsEvent(2, 6,
                                                       62);  // Center Skill
  inputController.switchMatrix()->registerFieldAsEvent(3, 6,
                                                       63);  // Upper Skill
  ...
  inputController.solenoids()->registerJ125(8,
                                            23);  // Flasher Lower Right Magnet
  ...
  inputController.eventDispatcher()->addListener(inputController.pupComLink(),
                                                 EVENT_SOURCE_ANY);
